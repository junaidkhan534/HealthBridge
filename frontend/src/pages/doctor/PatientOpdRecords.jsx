      ...
      {loading ? (
        ...
        <div className="space-y-12 print:space-y-0">
          {opdRecords.map((record, index) => (
            ...
            /* PAPER CONTAINER */
            /* Using page-break-after so if you print multiple records, they print on separate pages */
              ...
              <div className="px-6 py-3 border-b border-slate-200 print:px-4 print:py-2">
                <div className="grid grid-cols-3 gap-4 text-xs">
                  ...
                  <div className="flex flex-col gap-1 text-right">
                    <div><span className="font-bold text-slate-500 uppercase">Dr:</span> <span className="font-bold text-slate-900 text-sm">{user?.name || "Doctor"}</span></div>
                    ...
                    <div className="flex justify-between items-end">
                      <div className="w-1/3">
                        ...
                        <div className="font-bold text-sm text-slate-900 mt-1">
                          {record.followUpDate ? record.followUpDate.slice(0,10) : "As required"}
                        </div>
                      </div>
                      ...
                      <div className="text-center w-1/3">
                        ...
                        <div className="border-t border-slate-800 pt-1">
                          <p className="font-bold text-xs text-slate-900 m-0">Dr. {user?.name || "Signature"}</p>
