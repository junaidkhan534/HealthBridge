...
import InPatientPage from './pages/doctor/InPatientPage'; 
import PatientHistory from './pages/doctor/PatientHistory'; 
import PatientOpdRecords from './pages/doctor/PatientOpdRecords';
import PatientIpdRecords from './pages/doctor/PatientIpdRecords'; 
import PatHistory from './pages/patient/PatHistory'; 
import InPatientListPage from './pages/doctor/InPatientListPage'; 
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/admin/ward" element={<AdminRoute> <WardManagement /></AdminRoute> } />
        <Route path="/doctor/prescription/:id" element={<ProtectedRoute><PrescriptionPage /></ProtectedRoute>} />
        <Route path="/doctor/patient-history/:patientId/opd-records" element={<ProtectedRoute><PatientOpdRecords/></ProtectedRoute> } />
        <Route path="/doctor/patient-history/:patientId/ipd-records" element={<ProtectedRoute><PatientIpdRecords/></ProtectedRoute>} /> 
        <Route path="/patient/pat-history/:patientId" element={<ProtectedRoute><PatHistory/></ProtectedRoute>} /> 
        <Route path="/doctor/patient-history/:patientId" element={<ProtectedRoute><PatientHistory /></ProtectedRoute>} />
        <Route path="/doctor/inPatient/:id" element={<ProtectedRoute><InPatientPage /></ProtectedRoute>} />
        <Route path="/doctor/in-patient" element={<ProtectedRoute><InPatientListPage /></ProtectedRoute>} />
